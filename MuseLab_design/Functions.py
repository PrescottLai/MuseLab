...
def check_Sys_and_Open_File(Output_Position, Input_Position):
    ...
    if system_name == "Windows":
        ...
        try:
            ...
            # win32api.ShellExecute(0, 'open', 'MuseScore3.exe', Input_Position, '', 1)
        ...
        try:
            ...
            os.system("open -a MuseScore\ 3 " + Input_Position)
            print("try 結束")
    else:
...
def check_filename_available(filename):
    ...
    def check_meta(file_name):
        ...
        if os.path.isfile("./music/Output/" + file_name):
            file_name_new = file_name[:file_name.rfind('.')] + '_' + str(n[0]) + file_name[file_name.rfind('.'):]
            n[0] += 1
        if os.path.isfile("./music/Output/" + file_name_new):
