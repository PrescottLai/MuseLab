...
class Ui_Exit_Dialog(QMainWindow):
    ...
    def UiComponents(self):
        ...
        button1.setFont(font)
        button1.setStyleSheet("color: rgb(255, 255, 255);")
        button1.clicked.connect(self.CloseMainWindow)
...
class Ui_MainWindow(QMainWindow):
    def setupUi(self, MainWindow):
        ...
        self.welcomSentence = QtWidgets.QLabel(self.centralwidget)
        self.welcomSentence.setGeometry(QtCore.QRect(320, 150, 511, 41))
        font = QtGui.QFont()
        font.setFamily("Pyunji R")
        font.setPointSize(24)
        self.welcomSentence.setFont(font)
        self.welcomSentence.setAutoFillBackground(False)
        self.welcomSentence.setStyleSheet("color: #ef9072; border: rgb(255, 255, 255)")
        self.welcomSentence.setAlignment(QtCore.Qt.AlignCenter)
        self.welcomSentence.setObjectName("welcomSentence")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.welcomSentence.setText(_translate("MainWindow", "Welcome  To  The  MuseLab"))
