...
def melody_generate(file_path):
    ...
    # ---------------Change the note number by some musical rules for adding the 3rd & 5th & 6th & 8ve------------------
    Note_SolFaNameList3rd = Get_SolFa_Name(file_path)
    Note_SolFaNameList5th = Get_SolFa_Name(file_path)
    Note_SolFaNameList8ve = Get_SolFa_Name(file_path)
    Note_SolFaNameList6th = Get_SolFa_Name(file_path)
    SolFa_List = Get_SolFa_Name(file_path)
    ...
    track1.append(MetaMessage('set_tempo', tempo=166667, time=0))
    ...
    track3rd.append(MetaMessage('set_tempo', tempo=166667, time=0))
    ...
    long_note_track.append(MetaMessage('set_tempo', tempo=166667, time=0))
